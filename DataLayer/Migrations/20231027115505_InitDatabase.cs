        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_Persian = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Dissertation_Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    Allow_Edit = table.Column<bool>(type: "bit", nullable: true),
                    Abstract = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dissertation_FileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Status_Dissertation = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dissertations", x => x.Dissertation_Id);
                    table.ForeignKey(
                        name: "FK__Dissertat__Stude__34C8D9D1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__UserTB_Us__Stude__276EDEB3",
                        column: x => x.StudentID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DissertationRef = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__KeyWord__Dissert__37A5467C",
                        column: x => x.DissertationRef,
                        principalTable: "Dissertations",
                        principalColumn: "Dissertation_Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_DissertationRef",
                table: "Comments",
                column: "DissertationRef");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_UserRef",
                table: "Comments",
                column: "UserRef");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyWord_DissertationRef",
                table: "KeyWord",
                column: "DissertationRef");
